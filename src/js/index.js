/*
    ...
    - objetivo 2 - quando clicar no botão de troca de tema, caso o body já tenha a classe modo-escuro, remover a classe pra mudar pro modo claro e mudar a imagem pro brinco
        - passo 6 - verificar se o body ja tem classe modo-escuro
        - passo 7 - remover a classe do modo-escuro do body
        - passo 8 - trocar a imagem do botão de alterar tema pro brinco
*/
...
const imagemBotaoTrocaDeTema = document.querySelector(".imagem-brinco");
...
botaoAlterarTema.addEventListener("click", () => {
    ...
    if (modoEscuroEstaAtivo) {
        ...
        // passo 8 - trocar a imagem do botão de alterar tema pro brinco
        imagemBotaoTrocaDeTema.setAttribute("src", "./src/imagens/logo2.jpg");
